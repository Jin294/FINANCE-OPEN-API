    ...
    return (
        <div className={styles.backBody}>
            ...
            <div className={styles.titleExplain}>
                마이데이터를 사용하기 위해선 access-token을 발급 받아야합니다. access-token 발급 과정을 나타낸 시퀀스
                다이어그램입니다.
            </div>
            ...
            <div className={styles.step0Explain}>
                금융 더미데이터(마이데이터) 사용을 위해 Redirect URI를 등록하여 client-id와 secret-id 발급 받아야
                합니다.
                <br />
                <br />
            ...
            <pre id="json" className={styles.code}>
                https://j9b309.p.ssafy.io/oauth/authorize?response_type=code&client_id={'${client_id}'}&redirect_uri=
            ...
            <div className={styles.text}>
                ...
                <div className={styles.step1Explain}>
                    ...
                    <br />
                    2. 필수 파라미터를 포함해 POST로 요청합니다. 요청 성공 시 응답은 토큰과 토큰 정보를 포함합니다.
                    <br />
                    3. 액세스 토큰으로 마이데이터를 호출할 수 있습니다. 헤더에 Authorization : Bearer access-token을
                    담아 요청합니다.
                </div>
                <p>
            ...
            <pre id="json" className={styles.code}>
                ...
                <br />
                -H "Authorzation: Bearer {'${client-id:secret-id을 Base64로 인코딩한 값}'}<br />
